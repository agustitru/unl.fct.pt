...
public interface Authenticator {
	...
	void create_account(String name, String pwd1, String pwd2, int is_root, Sqlite_db db) throws AuthenticatorError;
	...
	Boolean login(HttpServletRequest req, HttpServletResponse resp, Sqlite_db db);
